...
#%%
for path,subdir,files in sorted(os.walk('/home/spri902/EGS_Collab/joint_inv/1104')):
    for filename in sorted(files):
        if filename.endswith(".dat"):
            ...
            #plt.figure()
            #plot_section(OThydata, dt=dt, ranges=None)
            plt.figure()
            seismic_wiggle(OThydata, dt=dt, picktimes=OTtrigger_times,scale=1,trnormalize=True)
...
# OTcorr_picks.to_csv(r'/home/spri902/EGS_Collab/picks/OT_PST_picks_1104.txt',\
#                       header=None,index=None,sep=' ',mode='a')
# sub_picks.to_csv(r'/home/spri902/EGS_Collab/picks/sub_picks_1104.txt',\
#                       header=None,index=None,sep=' ',mode='a')
# CASSMGeom.iloc[12:23].to_csv(r'/home/spri902/EGS_Collab/picks/RECgeometry_1104.txt',\
#                   index=None,sep=' ',mode='a')
# CASSMsrc.to_csv(r'/home/spri902/EGS_Collab/picks/SRCgeometry_1104.txt',\
#                   index=None,sep=' ',mode='a')   
...
#%% Read multiple days of picks files and combine
# filelist = sorted(os.listdir('/home/spri902/EGS_Collab/picks/'))

# OTcorr_picks = pd.concat([pd.read_csv(f,header=None,sep=' ') for f in filelist],ignore_index=True,axis=0)
# cntr = pd.DataFrame(np.linspace(1,7590,7590))
# OTcorr_picks.iloc[:,0] = cntr
# OTcorr_picks.columns = dfcols
# OTcorr_picks.to_csv(r'/home/spri902/EGS_Collab/picks/OT_PST_picks_all.txt',\
#                       header=None,index=None,sep=' ',mode='a')
# OTcull_picks = OTcorr_picks.drop(OTcorr_picks.index[3212:5741]).reset_index(drop=True)
# cntr = pd.DataFrame(np.linspace(1,5061,5061))
# OTcull_picks.iloc[:,0] = cntr
# OTcull_picks.to_csv(r'/home/spri902/EGS_Collab/picks/OT_PST_picks_cull.txt',\
#                       header=None,index=None,sep=' ',mode='a')
