...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 18 08:00:04 2022
...
#%%  fracture parameters
frac_depth = 164.5 # meters
frac_center = (2663/3.28084,-4255/3.28084,347.5/3.28084) #meters
frac_radius = 35 #meters
frac_angles = np.linspace(0,2*np.pi,101)
x_c = np.cos(frac_angles)*frac_radius + frac_center[0]
y_c = np.sin(frac_angles)*frac_radius + frac_center[1]
#%%
fig=plt.figure()
