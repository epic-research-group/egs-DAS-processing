...
def iDAS_timeAvg(files):
    ...
    if fs1 == fs2 == fs3 == float(1000):
        ...
        tdms_file1 = TdmsFile(file1).as_dataframe().iloc[:,PSBchans]
        tdms_file2 = TdmsFile(file2).as_dataframe().iloc[:,PSBchans]
        tdms_file3 = TdmsFile(file3).as_dataframe().iloc[:,PSBchans]
...
start = time.time()
dirpath = '/data1/parker/EGS_iDAS/20180523/'
os.chdir(dirpath)
postfix='tdms'
...
results.to_csv(r'/home/spri902/EGS_Collab/4850/results/maystim/processed_DAS/lpFilter/wellPSB/20180523_allchan.txt',\
                      header=True,index=None,sep=',',mode='a')

#%% Put separate dat files back together
os.chdir('/home/spri902/EGS_Collab/4850/results/maystim/processed_DAS/lpFilter/wellPSB/')
datFiles = sorted(os.listdir('/home/spri902/EGS_Collab/4850/results/maystim/processed_DAS/lpFilter/wellPSB/'))
